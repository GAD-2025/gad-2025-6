...
const PasswordSignUpPage = () => {
    ...
    return (
        <div style={{width: '100%', height: '100vh', background: 'white', overflow: 'hidden', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center'}}>
            ...
            {/* Main Content */}
            <div style={{width: 350, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 48, paddingBottom: 100}}>
                <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 16}}>
                    <div style={{alignSelf: 'stretch', color: 'var(--Black, black)', fontSize: 24, fontFamily: 'Pretendard', fontWeight: '700'}}>Password</div>
                    <div style={{color: 'var(--Gray-4, #9E9FAD)', fontSize: 16, fontFamily: 'Pretendard', fontWeight: '700'}}>Please set a password.</div>
                </div>
                <div style={{alignSelf: 'stretch', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 24}}>
                    <div style={{width: 350, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 8}}>
                        <div style={{alignSelf: 'stretch', color: '#D58699', fontSize: 24, fontFamily: 'Pangolin', fontWeight: '400', paddingLeft: 18}}>Password</div>
                        <div data-property-1="input.default.eyes" style={{alignSelf: 'stretch', height: 56, padding: 18, background: 'white', borderRadius: 20, border: '1px #EAEAEA solid', display: 'flex', alignItems: 'center', boxSizing: 'border-box', gap: 8}}>
                            <input
                            ...
                            />
                            <img src={passwordShown ? EyeOpenIcon : EyeClosedIcon} alt="Toggle password visibility" onClick={togglePasswordVisibility} style={{cursor: 'pointer'}} />
                        </div>
                    </div>
                    <div style={{width: 350, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 8}}>
                        <div style={{alignSelf: 'stretch', color: '#D58699', fontSize: 24, fontFamily: 'Pangolin', fontWeight: '400', paddingLeft: 18}}>Password confirmation</div>
                        <div data-property-1="input.default.eyes" style={{alignSelf: 'stretch', height: 56, padding: 18, background: 'white', borderRadius: 20, border: '1px #EAEAEA solid', display: 'flex', alignItems: 'center', boxSizing: 'border-box', gap: 8}}>
                            <input
                                ...
                                style={{flex: '1 1 0', border: 'none', outline: 'none', fontSize: 16, fontFamily: 'Pretendard', fontWeight: '400'}}
                            />
                           <img src={confirmPasswordShown ? EyeOpenIcon : EyeClosedIcon} alt="Toggle password visibility" onClick={toggleConfirmPasswordVisibility} style={{cursor: 'pointer'}} />
                        </div>
                    </div>
                    {error && <div style={{color: 'red', fontSize: 14, fontFamily: 'Pretendard', marginTop: -10, marginBottom: 10}}>{error}</div>}
                </div>
            </div>
