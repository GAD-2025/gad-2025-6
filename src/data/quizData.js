...
const createdQuizData = [
  { id: 9, title: 'Gato', description: 'A cat in Spanish', date: '2025. Oct. 22' },
  { id: 10, title: 'Perro', description: 'A dog in Spanish', date: '2025. Oct. 21' },
];

export { quizData, createdQuizData };
